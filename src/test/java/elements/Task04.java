...
public class Task04 {
    ...
    public static void main(String[] args) {
        ...
        emailInput.sendKeys("xxx34567@test.com");
        ...
        lastNameInput.sendKeys("Bishop");
        email.clear();
        email.sendKeys("xxx34567@test.com"); // trzeba stworzyć metodę która będzie tworzyć nowego maila z każdym uruchomieniem
